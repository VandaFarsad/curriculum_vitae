...
\intro{\name}{\jobtitle}{
	Hey! Ich bin Vanda und mit meiner Expertise in Python und Kenntnisse über DevOps- und Frontend-Technologien freue
	ich mich darauf, zur Gestaltung, Entwicklung und Optimierung deiner Webanwendungen beizutragen. Mit einem Auge für
	Details strebe ich danach, Lösungen zu entwickeln, die sowohl wartbar als auch testbar sind.
	Lass uns gemeinsam kreative Lösungen entwickeln!
}
