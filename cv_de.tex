...
\begin{cvtable}[3]
	...
	\cvitem{2008 -- 2010}{Wissenschaftliche Mitarbeiter}{Fraunhofer-Institut LBF}{Durchführung von Methodenimplementierungen
...
\begin{cvtable}[1.5]
	\cvitem{2014 -- 2017}{Promotion $\bullet$ Mathematik (\normalfont{summa cum laude})}{Universit\"at Hamburg}
	...
	\cvitem{2005 -- 209}{Diplom $\bullet$ Angewandte Mathematik ($\varnothing\, 1,3$)}{Hochschule Darmstadt}
