...
\intro{\name}{\jobtitle}{
	...
	mich darauf, zur Gestaltung, Entwicklung und Optimierung deiner Webanwendungen beizutragen. Mit einem Auge
	für Details und dem Ehrgeiz, qualitativ hochwertige Lösungen zu liefern, bin ich bestrebt, Benutzererfahrungen zu
	verbessern und eine nahtlose Funktionalität über den gesamten Entwicklungslebenszyklus hinweg sicherzustellen.
	Lass uns zusammen\-arbeiten, um innovative und effiziente Lösungen zu schaffen.
}
