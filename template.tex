...
\newgeometry{left=3in, right=0.1in, top=0.75in}

\intro{\name}{\jobtitle}{
	Hello there! Leveraging my proficiency in Python and a versatile background encompassing both DevOps and frontend
	technologies, I am enthusiastic about contributing to the design, development, and optimization of your web
	applications. With a keen eye for detail and a commitment to delivering high-quality solutions, I am poised to bring
	valuable insights and technical skills to enhance your project.
}
